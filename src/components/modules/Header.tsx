...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      ...
      {/* MOBILE MENU */}
      {showMobileMenu && (
        <div className="md:hidden bg-white text-black absolute inset-x-0 top-[60px] shadow-2xl z-50 max-h-[80vh] overflow-auto">
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-2 text-sm border-t pt-4">
              <Link href="#flash-sale" className="flex items-center gap-2 py-2"><Flame className="h-4 w-4 text-orange-500" /> Ofertas Relámpago</Link>
              <Link href="#b2b" className="flex items-center gap-2 py-2"><Award className="h-4 w-4" /> Venta Mayorista B2B</Link>
              <Link href="#" className="flex items-center gap-2 py-2"><FileText className="h-4 w-4" /> Cotizaciones</Link>
              <a href="mailto:ventas@starshop.cl" className="flex items-center gap-2 py-2"><Mail className="h-4 w-4" /> ventas@starshop.cl</a>
