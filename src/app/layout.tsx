    ...
    <html lang="es-CL" suppressHydrationWarning>
      <body className={`${inter.variable} font-sans bg-[#F5F5F5] dark:bg-zinc-950`}>
        <Providers>
          ...
          <footer className="relative bg-black text-white mt-12 overflow-hidden">
            {/* Capa estrellas: tenues (40%) sobre el negro, por todo el footer */}
            <div aria-hidden className="pointer-events-none absolute inset-0 z-0 bg-[url('/back-stars.webp')] bg-repeat opacity-40" />
            {/* Logo mascota: con su transparencia natural, sobre las estrellas */}
            <div aria-hidden className="pointer-events-none absolute inset-0 z-0 bg-[url('/logo-footer-mascota.png')] bg-no-repeat bg-[position:right_20px_bottom_20px] bg-[length:220px] md:bg-[length:300px]" />
