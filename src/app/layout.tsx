      ...
      <body className={`${inter.variable} font-sans bg-[#F5F5F5] dark:bg-zinc-950`}>
        <Providers>
          ...
          <footer className="bg-[#232F3E] text-white mt-12">
            <div className="container py-12 px-4 pr-12 pb-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-sm bg-[url('/logo_footer_mascota.png')] bg-no-repeat bg-right-bottom bg-[length:142px]">
              {/* Marca */}
              <div>
